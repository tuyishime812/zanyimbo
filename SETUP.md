...
5. Enter:
   - Email: `admin@zanyimbo.com` (or your email)
...
2. Navigate to project:
   ```bash
   cd C:\Users\Student.LAPTOP-46MOQA5A\Desktop\projects\zanyimbo\zanyimbo
   ```
3. Run:
   ```bash
   npm run dev
